...
#define ROW (1<<16|1<<17|1<<18|1<<19)
#define COL (1<<20|1<<21|1<<22|1<<23)
...
int main()
{
	...
	label1:while(1)
	{
		...
		if(z != 0xf00000)
		{
			if(z == 0xe00000)				//gives col 1
			{
				y = rowdefine();			//finding row adress and printing
				goto label;
				
			}
			if(z == 0xd00000)				//gives col 2
			{
				y = rowdefine();
				goto label;
				
			}
			if(z == 0xb00000)				// gives col 3
			{
				y = rowdefine();
				goto label;
				
			}	
			if(z == 0x700000)				//gives col 4
			{
				y = rowdefine();
				goto label;
			}
...
long rowdefine()
{
	int y =0;
		...
		y = (IOPIN1 & ROW);		   //y=0x1e0000	 check wheather row is pressed or not
			if(y != 0xf0000)
			{
				if(y == 0xe0000)		  //gives row 1
				{
					return y;	
				}
				if(y == 0xd0000)		   //gives row 2
				{
					return y;
				}
				if(y == 0xb0000)		   //gives row 3
				{
					return y;
				}
				if(y == 0x70000)			//gives row 4
				{
					return y;
				}
			}
